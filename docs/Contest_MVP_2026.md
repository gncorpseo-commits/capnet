...
| 주 | 날짜(대략) | 산출물 |
|----|------------|--------|
| **W0** | 8/1–3 | 범위 동결, **가중치=scratch 확정**, LICENSE, CapNet 출품명, 골든셋 `docs/golden/` 편입, 주최 문의 |
...
| ID | 기능 |
|----|------|
| M22 | 결과보고서 (서두에 [user-guide-ko](./user-guide-ko.md) 요지) |
| M23 | 시연 영상 ≤3분 (§7) |
...
쉬운 말: [user-guide-ko.md](./user-guide-ko.md)
...
| 초 | 화면 | 말/자막 |
|----|------|---------|
| 0–20 | 문제 | 모델 스토어가 아니라 **채점 가능한 능력 계약** |
...
전체 본문: **[docs/user-guide-ko.md](./user-guide-ko.md)** (IT 비전문가용 · 영문 파일명).
...
- [ ] [user-guide-ko.md](./user-guide-ko.md) 링크  
- [ ] [golden/image-classify-v1.md](./golden/image-classify-v1.md) 정본 1개  
- [ ] 결과보고서 (위반 표 1장)  
- [ ] 시연 영상 ≤3분 (§7)  
- [ ] 소스·가중치 출처 깨끗  
- [ ] SPDX/라이선스 자가 점검  
...
5. [x] 골든셋 **정본 1개** `docs/golden/image-classify-v1.md` v0.2 + 중복/한글 파일 제거  
