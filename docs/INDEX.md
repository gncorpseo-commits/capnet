...
[`bridge/queue-batches.md`](./bridge/queue-batches.md) (C→D→최종) · [`bridge/handoff-long-mode-claude.md`](./bridge/handoff-long-mode-claude.md) · [`bridge/autonomous-mode.md`](./bridge/autonomous-mode.md)
